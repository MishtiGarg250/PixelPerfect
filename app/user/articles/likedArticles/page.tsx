      ...
      <div className="relative z-10 py-10 px-4 md:px-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mt-6">
            <Button
              variant="outline"
              className="border-[#b5b5f6]/30 text-[#b5b5f6] hover:bg-[#b5b5f6]/10 hover:border-[#b5b5f6]/50 transition-all duration-300 rounded-full"
            >
            ...
            <Button
              variant="outline"
              className="border-[#f7bff4]/30 text-[#f7bff4] hover:bg-[#f7bff4]/10 hover:border-[#f7bff4]/50 transition-all duration-300 rounded-full"
            >
