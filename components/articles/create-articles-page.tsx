...
export function CreateArticlePage(){
    ...
    return(
        <div className="max-w-4xl mx-auto p-6">
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl text-purple-200/50">Create new Article</CardTitle>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6 text-purple-200/50">
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <Button disabled={isPending} type="submit" className="bg-white text-purple-500">{isPending ? "Loading...": "Publish Articles"}</Button>
                        </div>
                    </form>
                </CardContent>
            </Card>
